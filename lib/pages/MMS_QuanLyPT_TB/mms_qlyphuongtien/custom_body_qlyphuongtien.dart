...
import '../mms_lichsucongviec/lichsucv.dart';
import '../mms_yeucaucongviec/yeucaucv.dart';
import '../../qlkho/QLKhoXe.dart';

// ignore: use_key_in_widget_constructors
class CustomBodyQLyPhuongTien extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(width: 100.w, child: BodyQLyPhuongTienScreen());
  }
}

class BodyQLyPhuongTienScreen extends StatefulWidget {
  const BodyQLyPhuongTienScreen({Key? key}) : super(key: key);

  @override
  _BodyQLyPhuongTienScreenState createState() => _BodyQLyPhuongTienScreenState();
}

// ignore: use_key_in_widget_constructors, must_be_immutable
class _BodyQLyPhuongTienScreenState extends State<BodyQLyPhuongTienScreen> with TickerProviderStateMixin, ChangeNotifier {
  int currentPage = 0;
  int pageCount = 3;
  bool _loading = false;
        ...
        : SingleChildScrollView(
            child: Container(
              ...
              child: Wrap(
                ...
                children: [
                  if (userHasPermission(menuRoles, 'yeu-cau-cong-viec-mobi'))
                    CustomButton(
                      'YÊU CẦU CÔNG VIỆC',
                      Stack(
