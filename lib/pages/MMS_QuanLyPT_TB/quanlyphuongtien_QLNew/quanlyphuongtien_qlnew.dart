...
import 'baoduong_qlnew.dart';
import 'ganmooc_thietbi_ql.dart';
import 'suachua_qlnew.dart';

class QuanLyPhuongTienQLNewPage extends StatefulWidget {
  final String? id;
  final int tabIndex;
  const QuanLyPhuongTienQLNewPage({super.key, required this.id, this.tabIndex = 0});

  @override
  State<QuanLyPhuongTienQLNewPage> createState() => _QuanLyPhuongTienQLNewPage();
}

class _QuanLyPhuongTienQLNewPage extends State<QuanLyPhuongTienQLNewPage> with SingleTickerProviderStateMixin, ChangeNotifier {
              ...
              Expanded(
                child: Container(
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      // CustomBodyNoiDungBaoDuongQL(id: widget.id),
                      ...
                      CustomBodyGanMoocTB_QL(id: widget.id),
                      CustomBodyBaoDuongQLNew(id: widget.id),
                      CustomBodySuaChuaQLNew(id: widget.id),
                      PageNew(),
                      PageNew(),
                    ],
                  ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TabBar(
                    ...
                    controller: _tabController,
                    tabs: const [
                      // Tab(icon: Icon(Icons.build), text: 'Nội dung bảo dưỡng'),
