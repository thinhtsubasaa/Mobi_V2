...
class CustomBodyDSSuaChua extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(child: BodyDSSuaChuaScreen());
  }
}

class BodyDSSuaChuaScreen extends StatefulWidget {
  const BodyDSSuaChuaScreen({Key? key}) : super(key: key);

  @override
  _BodyDSSuaChuaScreenState createState() => _BodyDSSuaChuaScreenState();
}

class _BodyDSSuaChuaScreenState extends State<BodyDSSuaChuaScreen> with TickerProviderStateMixin, ChangeNotifier {
