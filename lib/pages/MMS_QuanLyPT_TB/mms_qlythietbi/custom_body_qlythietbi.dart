...
class CustomBodyQLyThietBi extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(width: 100.w, child: BodyQLyThietBiScreen());
  }
}

class BodyQLyThietBiScreen extends StatefulWidget {
  const BodyQLyThietBiScreen({Key? key}) : super(key: key);

  @override
  _BodyQLyThietBiScreenState createState() => _BodyQLyThietBiScreenState();
}

// ignore: use_key_in_widget_constructors, must_be_immutable
class _BodyQLyThietBiScreenState extends State<BodyQLyThietBiScreen> with TickerProviderStateMixin, ChangeNotifier {
  int currentPage = 0;
  int pageCount = 3;
  bool _loading = false;
              ...
              child: Wrap(
                ...
                children: [
                     ...
                     if (userHasPermission(
                      menuRoles, 'yeu-cau-cong-viec-mobi'))
                    CustomButton(
                      'YÊU CẦU CÔNG VIỆC',
                      Stack(
                     ...
                     if (userHasPermission(
                      menuRoles, 'lich-su-cong-viec-mobi'))
                    CustomButton(
                      'LỊCH SỬ CÔNG VIỆC',
                      Stack(
                        alignment: Alignment.center,
