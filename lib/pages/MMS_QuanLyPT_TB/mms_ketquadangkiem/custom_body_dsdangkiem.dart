...
class CustomBodyDSDangKiem extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(child: BodyDSDangKiemScreen());
  }
}

class BodyDSDangKiemScreen extends StatefulWidget {
  const BodyDSDangKiemScreen({Key? key}) : super(key: key);

  @override
  _BodyDSDangKiemScreenState createState() => _BodyDSDangKiemScreenState();
}

class _BodyDSDangKiemScreenState extends State<BodyDSDangKiemScreen> with TickerProviderStateMixin, ChangeNotifier {
