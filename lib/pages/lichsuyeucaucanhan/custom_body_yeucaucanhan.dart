...
class CustomBodyDSCaNhan extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(child: BodyDSCaNhanScreen());
  }
}

class BodyDSCaNhanScreen extends StatefulWidget {
  const BodyDSCaNhanScreen({super.key});

  @override
  _BodyDSCaNhanScreenState createState() => _BodyDSCaNhanScreenState();
}

class _BodyDSCaNhanScreenState extends State<BodyDSCaNhanScreen> with TickerProviderStateMixin, ChangeNotifier {
  ...
  Future<void> getListThayDoiKH(String? ngay, String? keyword) async {
    ...
    try {
      final http.Response response = await requestHelper.getData('Kho/GetLichSuYeuCauCaNhan?Ngay=$ngay&keyword=$keyword');
