...
class CustomBodyDSCaNhanDiGap extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(child: BodyDSCaNhanDiGapScreen());
  }
}

class BodyDSCaNhanDiGapScreen extends StatefulWidget {
  const BodyDSCaNhanDiGapScreen({super.key});

  @override
  _BodyDSCaNhanDiGapScreenState createState() => _BodyDSCaNhanDiGapScreenState();
}

class _BodyDSCaNhanDiGapScreenState extends State<BodyDSCaNhanDiGapScreen> with TickerProviderStateMixin, ChangeNotifier {
  ...
  Future<void> getListThayDoiKH(String? ngay, String? keyword) async {
    ...
    try {
      final http.Response response = await requestHelper.getData('XeDiGap/GetLichSuYeuCauCaNhanDiGap?Ngay=$ngay&keyword=$keyword');
