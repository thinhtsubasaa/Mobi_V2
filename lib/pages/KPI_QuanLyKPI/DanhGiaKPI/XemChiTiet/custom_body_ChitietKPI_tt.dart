...
class CustomBodyChiTietKPI extends StatelessWidget {
  final String? id;
  CustomBodyChiTietKPI({required this.id});
  @override
  Widget build(BuildContext context) {
    return Container(
        child: BodyChiTietKPIScreen(
      id: id,
      lstFiles: [],
    ));
  }
...
class BodyChiTietKPIScreen extends StatefulWidget {
  final String? id;
  final List<CheckSheetFileModel?> lstFiles;
  const BodyChiTietKPIScreen({super.key, required this.id, required this.lstFiles});

  @override
  _BodyChiTietKPIScreenState createState() => _BodyChiTietKPIScreenState();
}

class _BodyChiTietKPIScreenState extends State<BodyChiTietKPIScreen> with TickerProviderStateMixin, ChangeNotifier {
