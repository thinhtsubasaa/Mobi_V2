...
class BodyGiaoChiTieuKPIScreen extends StatefulWidget {
  final String? id;
  final List<CheckSheetFileModel?> lstFiles;
  const BodyGiaoChiTieuKPIScreen({super.key, required this.id, required this.lstFiles});

  @override
  _BodyGiaoChiTieuKPIScreenState createState() => _BodyGiaoChiTieuKPIScreenState();
}

class _BodyGiaoChiTieuKPIScreenState extends State<BodyGiaoChiTieuKPIScreen> with TickerProviderStateMixin, ChangeNotifier {
