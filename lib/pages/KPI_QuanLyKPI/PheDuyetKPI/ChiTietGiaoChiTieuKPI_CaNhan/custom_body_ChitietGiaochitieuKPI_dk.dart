...
class BodyGiaoChiTieuKPIScreen2 extends StatefulWidget {
  final String? id;
  final List<CheckSheetFileModel?> lstFiles;
  final bool isChiTiet;
  const BodyGiaoChiTieuKPIScreen2({super.key, required this.id, required this.lstFiles, required this.isChiTiet});

  @override
  _BodyGiaoChiTieuKPIScreen2State createState() => _BodyGiaoChiTieuKPIScreen2State();
}

class _BodyGiaoChiTieuKPIScreen2State extends State<BodyGiaoChiTieuKPIScreen2> with TickerProviderStateMixin, ChangeNotifier {
  ...
  Future<void> saveTuChoi(
    ...
    try {
      ...
      final res = await requestHelper.putData(
        'vptq_kpi_KPICaNhan/tra-cap-duoi/$id',
        payload, // không body
      );
      ...
      if (res.statusCode == 200) {
        QuickAlert.show(
          ...
          title: 'Thành công',
          text: 'Từ chối duyệt KPI cá nhân thành công',
  ...
  Future<void> saveDuyet(
    ...
    try {
      ...
      final res = await requestHelper.putData(
        'vptq_kpi_KPICaNhan/gui-duyet-cap-tren/$id',
        null, // không body
      );
