...
class BodyCSGiaoChiTieuKPIScreen extends StatefulWidget {
  final String? id;
  final List<CheckSheetFileModel?> lstFiles;
  const BodyCSGiaoChiTieuKPIScreen({super.key, required this.id, required this.lstFiles});

  @override
  _BodyCSGiaoChiTieuKPIScreenState createState() => _BodyCSGiaoChiTieuKPIScreenState();
}

class _BodyCSGiaoChiTieuKPIScreenState extends State<BodyCSGiaoChiTieuKPIScreen> with TickerProviderStateMixin, ChangeNotifier {
  ...
  Future<void> getListData(
    ...
    try {
      final http.Response response = await requestHelper.getData('vptq_kpi_KPICaNhan/$id');
