...
//     String? savedKhoXeId = prefs.getString('KhoXeId');
//     String? savedBaiXeId = prefs.getString('BaiXeId');
//     String? savedViTriId = prefs.getString('ViTriId');
//     await getData();
...
//     SharedPreferences prefs = await SharedPreferences.getInstance();
//     await prefs.setString('KhoXeId', KhoXeId ?? '');
//     await prefs.setString('BaiXeId', BaiXeId ?? '');
//     await prefs.setString('ViTriId', ViTriId ?? '');
//   }
