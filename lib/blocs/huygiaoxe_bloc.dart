...
class HuyGiaoXeBloc extends ChangeNotifier {
  ...
  Future<void> getData(BuildContext context, String qrcode) async {
    ...
    _giaoxe = null;
    try {
      final http.Response response = await requestHelper.getData('KhoThanhPham/GetSoKhungHuyGiaoXemobi?SoKhung=$qrcode');
